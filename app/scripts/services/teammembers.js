...
angular.module('seedApp')
  .factory('TeamMembers', function () {
    var teamMembers = [{
      ...
      summary: 'Christopher was previously an engineer at Google and Simple. He has also consulted numerous clients on secruity and cryptography. He has published a book on crytography, Modern Cryptanalysis. Christopher has a PhD in Computer Science from University of Tulsa.',
